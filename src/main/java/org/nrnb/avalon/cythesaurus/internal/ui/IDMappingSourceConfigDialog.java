...
public class IDMappingSourceConfigDialog extends javax.swing.JDialog {
	...
	public void init() {
		...
		srcTree.addTreeSelectionListener(new TreeSelectionListener() {
			/*
			 * on the select tree value changed. call this method to handle the event
			 * 2013-9-19:下午11:13:12<br>
			 */
	...
	private void closeButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_closeButtonActionPerformed
		...
		try {
			...
			JOptionPane.showMessageDialog(this,
					"Failed to save the current resources.");
		}
	...
	private void saveAsDefaultButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveAsDefaultButtonActionPerformed
		int ret = JOptionPane.showConfirmDialog(this,
				"Are you sure to replace the default resources with"
		...
		JOptionPane.showMessageDialog(this,
				"The current resources has been save as default.");
	...
	private void loadDefaultButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loadDefaultButtonActionPerformed
		int ret = JOptionPane.showConfirmDialog(this,
				"Are you sure to load the default resources?\n"
						+ "The current resources will be replaced with the default ones.",
		...
		srcTree.reset();
		JOptionPane.showMessageDialog(this,
				"The default resources has been loaded.");
	...
	private class LoadClientDescTask extends AbstractTask {
		...
		private String getDescription() throws IDMapperException {
			...
			// TODO: temporally comment the next line, I don't know that it is useful
			// in 3.0, or not?
